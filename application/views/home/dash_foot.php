...
<!--           <li><a href="#">MVP</a></li> -->
          <li><a href="<?php echo base_url();?>assets/whitepaper_0.1.pdf" target="_blank">Whitepaper</a></li>
        </ul>
        <div class="wi-content wi-social">
          ...
          <a href="#" class="a_col">help@kicksportsmanager.com</a>
          <p>Kick Software LTD</p>
          <h1>© 2018 Kick Sports Manager</h1>
        </div>
      </div>
    </div>
  </div>
