...
<!-- Fav Icon  -->
<link rel="shortcut icon" href="https://kicksportsmanager.com/images/favicon_kick.png">
<!-- Site Title  -->
...
<!-- <div class="select-box"> -->
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            <ul class="locales">
               ...
               <li><a href="<?php echo BASE_URL()?>index.php/LangSwitch/switchLanguage/english" class="item "><i class="flag1"><img src="<?php echo site_url(); ?>images/gb.png" /></i><span class="title">English</span></a></li>
                                    ...
                                    <?php } ?><!-- li><a class="item "><i class="flag1"><img src="<?php echo site_url(); ?>images/gb.png" /></i><span class="title">हिन्दी</span></a></li>
    ...
    <ul class="dwn">
      ...
      <li><a href="#"  data-toggle="modal" data-target="#loginModal1"><i class="fa fa-cog"></i><?php echo $this->lang->line('CONFIGURAÇÕES');?></a></li>
      <li><a  href="<?php echo site_url() ?>index.php/User/logout"><i class="fa fa-sign-out" aria-hidden="true"></i><?php echo $this->lang->line('LOG_OUT');?></a></li>
  </ul>
</div>
</div>
</nav>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="tab-bar-new">
                    <div id="tabl1" class="tab2 active">
                        <span id="log_in1"><?php echo $this->lang->line('Change_Password');?></span>
                    </div>
                    <div id="tabr1" class="tab2">
                        <span id="reg_win1"><?php echo $this->lang->line('2-Step');?></span>
                    </div>
                </div>
            </div>
                ...
                <div class="tab-content">
                    ...
                    <div class="centered-button">
                        <button class="button blue mid center" type="button" onclick="change_pass();"><div class="loader" style="display:none;"></div>
                            <span data-lokalise="true" data-key="AUTH.PASSWORD_RESET.CHANGE_PASSWORD_BUTTON"><?php echo $this->lang->line('Change_Password');?></span>
                        </button></div>
                        <?php echo form_close();?>
                    </div>
            ...
            function change_pass(){
                ...
                $.ajax({
                    type : "POST",
                    url : "<?php echo base_url(); ?>index.php/User/change_pass",
...
function formsubmit(){
    $.ajax({
        type : "POST",
        url : "<?php echo base_url(); ?>index.php/User/enable",
