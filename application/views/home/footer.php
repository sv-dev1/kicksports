		...
		<div class="row">
			...
			<div class="col-sm-6 col-xl-4 res-l-bttm">
				<div class="footer-subscription">
					<h6 class="animated" data-animate="fadeInUp" data-delay=".6"><?php echo $this->lang->line('Subscreve');?></h6>
			...
			<div class="col-xl-4">
				<ul class="link-widget animated" data-animate="fadeInUp" data-delay=".8">
					...
					<li><a href="#" class="menu-link"><?php echo $this->lang->line('Comprar');?></a></li>
					<li><a href="#" class="menu-link">Roadmap</a></li>
					<li><a href="<?php echo base_url();?>assets/whitepaper_0.1.pdf" target="_blank" class="menu-link">Whitepaper</a></li>
					<li><a href="#" class="menu-link"><?php echo $this->lang->line('Contacto');?></a></li>
				</ul>
			</div><!-- .col  -->
		</div><!-- .row  -->
		...
		<div class="row">
			...
			<div class="col-md-5 text-right mobile-left">
				<ul class="footer-links animated" data-animate="fadeInUp" data-delay="1">
					...
					<li><a href="<?php echo base_url();?>terms"><?php echo $this->lang->line('Termos');?></a></li>
					<li>
...
<script defer type="text/javascript" src="<?php echo site_url(); ?>assets/js/moment.js"></script>
<script defer type="text/javascript" src="<?php echo site_url(); ?>assets/js/moment-timezone.js"></script>
<script defer type='text/javascript' src="<?php echo site_url(); ?>assets/js/jquery.bundle.js?ver=113"></script>
<script defer type='text/javascript' src="<?php echo site_url(); ?>assets/js/script.js?ver=113"></script>
