				...
				<div class="row">
					<div class="col-md-6 col-xs-12">
						<div class="left_left full_left">
							<h3><?php echo $this->lang->line('Investimento');?></h3>
							<div class="bunny">
							...
							<ul class="big_btnn">
								...
								<div class="contract-info1">
									<span>KICK <?php echo $this->lang->line('Endereço_do');?></span>
						...
						<div class="col-md-6 col-xs-12">
							...
							$date2=strtotime(date('2018/10/13'));
							
							if(strtotime(date("Y/m/d")) < $date2){  ?>
...
<!-- <div class="progress-bar">
  ...
  <div class="progress" style="width: 0%;"><span class="percent"></span></div>
</div> -->
<h1 class="raised"><?php echo ($data_raised !='')?number_format($data_raised,'2','.',''):'0';?> ETH</h1>
<br>
...
<div class="col-md-3 col-xs-12 pad">
	<div class="right_four">
		<button><a href="<?php echo base_url();?>assets/whitepaper_0.1.pdf" target="_blank" style="color: #26379f;">Whitepaper</a></button>
	</div>
</div>
...
<div class="row">
	<div class="col-md-9 col-xs-12 ">
		<div class="left_eight full_left">
			<h1><?php echo $this->lang->line('História');?></h1>
							...
							<tr>
								<td>
									...
									<?php if($result1->type == 'eth'){?>
										<a href="http://etherscan.io/tx/<?php echo $result1->transaction_hash;?>" target="_blank"><?php echo ($result1->transaction_hash!= '')?$result1->transaction_hash:'BONUS';?></a>
									<?php }else if($result1->type == 'btc'){?>
										<a href="https://blockchain.info/tx/<?php echo $result1->transaction_hash;?>" target="_blank"><?php echo ($result1->transaction_hash!='')?$result1->transaction_hash:'BONUS';?></a>
									<?php }?>    
								</td>
								<td><?php echo $result1->date;?></td>
								<td>+<?php echo $result1->bunny;?>  KICK</td>
								<td><?php echo ($result1->status==1)?'success':'bonus';?></td>

							</tr>

						<?php }}else{?>
							<span><?php echo $this->lang->line('Aqui_seu');?></span>
		...
		<div class="col-md-3 col-xs-12 pad">
			<div class="right_four">
				<div class="video-preview">
					<img src="<?php echo site_url() ?>assets/images/back.jpg" class="img-responsive" />
				...
				<h2 class="personal-header"><span><?php echo $this->lang->line('Bounty');?></span><i class="info-mark"></i></h2>
				<div class="personal-text"><span><?php echo $this->lang->line('Share_link');?></span></div>
				<form>
											...
											<div class="item " style="left: 10%;">
												...
												<div class="item " style="left: 20%;">
													...
													<div class="scale bottom">
														...
														<div class="row">
															<div class="col-full"><label class="input-label" for="address"><span><?php echo $this->lang->line('Payment_Address');?></span></label>
														...
														<div class="payment-additional-ethereum">
															<div class="row">
																<div class="col-half"><label class="input-label" for="address"><span><?php echo $this->lang->line('Gas_limit');?></span></label>
																	<div class="value-item">21,000<span class="symbol"> </span></div>
																</div>
																<div class="col-half"><label class="input-label" for="address"><span><?php echo $this->lang->line('Gas_price');?></span></label>
										...
										<div class="modal fade" id="myModalbitcoin" role="dialog">
											<div class="modal-dialog">
												...
												<div class="modal-content">
													...
													<div class="modal-body">
														<div class="payment">
															<h2 class="personal-header"><span><?php echo $this->lang->line('Buy_Ethereum');?></span></h2><label class="input-label" for="amount"><span><?php echo $this->lang->line('Amount_BTC');?></span></label>
															<div class="row">
																<div class="col-amount">
																								...
																								<div class="scale bottom">
																									...
																									<div class="row">
																										<div class="col-full"><label class="input-label" for="address"><span><?php echo $this->lang->line('Payment_Address');?></span></label>
																											...
																											<div class="exchanges-text"><span>You can send Bitcoin from exchanges</span></div>
																										</div>
																									</div>
																									<div class="payment-additional-ethereum">
...
<!-- 
	<a type="button" id="a_mdl" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal123">Open Modal</a> -->
	...
	<button type="button" id="a_mdl"  data-video="//www.youtube.com/watch?v=3Nh2Bj60A2w" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal123">Open Modal</button>
	<!-- Modal -->
		...
		<div class="modal-dialog"> 
			...
			<div class="modal-content modal-content1">  
				...
				<div class="modal-body modal-body1">
					<iframe id="videoo" width="100%" height="350" src="https://www.youtube.com/embed/3Nh2Bj60A2w" frameborder="0" allowfullscreen ></iframe>
				</div>
	...
	<script type="text/javascript">
      ...
      if(!web3.isConnected()) {
      	$("button.transferFunds").click(function(){
      		alert('You need to install metamask here is the link please copy and paste,"https://metamask.io/"');
      	});
...
<script>
	...
	var raised = function() { 
		...
		$.ajax({
			...
			success: function(html){
				if((html!='')){
					var soft_cap = <?php echo get_data_by_id('total_supply','title','soft_cap','supply');?>;
					var div = Math.round(html/soft_cap)*100;
					
       //$(".raised").text( html.toFixed() + 'ETH');
      // progress1
      $('.full_left .progress').css('width', div+'%');
      $('.full_left .percent').text( div+'%');
  }
}
});
